...
## Base URL
```
Development: https://rockmartialartsacademy.com/api/users
...
```bash
curl -X GET "https://rockmartialartsacademy.com/api/users?role=student&branch_id=branch-123" \
  -H "Authorization: Bearer <coach_token>"
```

### Update User Information (Super Admin)
```bash
curl -X PUT "https://rockmartialartsacademy.com/api/users/user-uuid-here" \
